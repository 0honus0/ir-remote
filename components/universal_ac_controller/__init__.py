...
CONF_MODEL_LIST_CONTROL = "model_list_control"
...
CONFIG_SCHEMA = cv.Schema(
    {
        ...
        cv.Required(CONF_MODEL_LIST_CONTROL): cv.use_id(text_sensor.TextSensor),
    }
...
async def to_code(config):
    ...
    model_list_control = await cg.get_variable(config[CONF_MODEL_LIST_CONTROL])
    ...
    cg.add(var.set_model_list_control(model_list_control))
